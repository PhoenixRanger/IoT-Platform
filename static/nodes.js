...
function createFleetRow(node) {
 ...
 [[`/?node_id=${encodedNodeId}`, "Dashboard"], [`/nodes/${encodedNodeId}`, "Details"], [`/nodes/${encodedNodeId}/technical`, "Technical"], [`/nodes/${encodedNodeId}/configuration`, "Configuration"]].forEach(([href, text]) => { const link = document.createElement("a"); link.href = href; link.textContent = text; menu.append(link); });
